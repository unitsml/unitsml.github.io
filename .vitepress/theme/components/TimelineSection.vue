...
const entries: TimelineEntry[] = [
  ...
  },
  {
    ...
    description: 'The "Units Markup Language" presentation at Open Forum 2003 on Metadata Registries. Work led by Bob Dragoset (NIST) with Barry Taylor, Michael McLay, Frank Olken, and Peter Murray-Rust (CML).',
  ...
  },
  {
    ...
    description: 'NIST proposes standardization. The OASIS TC "UnitsML" is formed, convened by Simon Frechette (NIST). Major participants include NIST, IBM, Granta Design, NPL, and Univ. of North Florida.',
  ...
  },
  {
    ...
    description: 'CalConnect creates TC UNITS to carry on the UnitsML work. Karen Olsen (NIST) and Nick Nicholas (Ribose) co-chair the technical committee.',
    people: ['Karen Olsen', 'Nick Nicholas'],
