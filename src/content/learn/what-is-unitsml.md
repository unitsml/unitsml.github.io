...
- UnitsDB includes comprehensive SI unit definitions aligned with the *BIPM SI Brochure* and the **BIPM Digital SI Framework**
- UnitsDB references **IEC/TS 62720** units in the IEC Common Data Dictionary (CDD), supporting industrial automation and product-data dictionaries
